...
class StoryBrain {
  ...
  void nextStory(int userChoice) {
    if (_storyIndex == 0 && userChoice == 1) {
      _storyIndex = 2;
    } else if (_storyIndex == 0 && userChoice == 2) {
      _storyIndex = 1;
    } else if (_storyIndex == 1 && userChoice == 1) {
      _storyIndex = 2;
    } else if (_storyIndex == 1 && userChoice == 2) {
      _storyIndex = 3;
    } else if (_storyIndex == 2 && userChoice == 1) {
      _storyIndex = 5;
    } else if (_storyIndex == 2 && userChoice == 2) {
      _storyIndex = 4;
